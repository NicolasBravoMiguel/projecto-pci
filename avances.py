...
dietas_hombres = {
    "1500-1800": ["Desayuno: Avena y frutas", 
                  "Almuerzo: Pollo a la plancha con vegetales", 
                  "Cena: Pescado con ensalada"],
    "1801-2000": ["Desayuno: Huevos con aguacate", 
                  "Almuerzo: Pasta con pollo", 
                  "Cena: Salmón con quinoa"],
    "2001-2200": ["Desayuno: Batido de proteínas", 
                  "Almuerzo: Hamburguesa de pavo", 
                  "Cena: Filete con espárragos"],
    "2201-2500": ["Desayuno: Pan integral con mantequilla de maní", 
                  "Almuerzo: Ensalada de atún", 
                  "Cena: Pechuga de pollo con arroz"],
    "2501-2800": ["Desayuno: Yogurt con granola", 
                  "Almuerzo: Ensalada César con pollo", 
                  "Cena: Lomo de cerdo con batata"],
    "2801-3100": ["Desayuno: Smoothie de frutas", 
                  "Almuerzo: Pollo al curry", 
                  "Cena: Filete de pescado con patatas"],
    "3101-3300": ["Desayuno: Tortilla con jamón", 
                  "Almuerzo: Pasta boloñesa", 
                  "Cena: Chuletas de cerdo con ensalada"],
    "3301-3600": ["Desayuno: Bagel con queso crema", 
                  "Almuerzo: Pollo teriyaki con arroz", 
                  "Cena: Pizza casera con ensalada"],
    "3601-4000": ["Desayuno: Tostadas francesas", 
                  "Almuerzo: Pollo al horno con patatas", 
                  "Cena: Lasagna de carne"]
}

dietas_mujeres = {
    "1500-1800": ["Desayuno: Avena con almendras", 
                  "Almuerzo: Ensalada de quinoa", 
                  "Cena: Pescado con brócoli"],
    "1801-2000": ["Desayuno: Batido verde", 
                  "Almuerzo: Wrap de pollo", 
                  "Cena: Tacos de pescado"],
    "2001-2200": ["Desayuno: Pan integral con aguacate", 
                  "Almuerzo: Salmón con arroz integral", 
                  "Cena: Ensalada con tofu"],
    "2201-2500": ["Desayuno: Yogurt con frutas", 
                  "Almuerzo: Sándwich de pavo", 
                  "Cena: Filete de pescado con ensalada"],
    "2501-2800": ["Desayuno: Smoothie de bayas", 
                  "Almuerzo: Pasta integral con pollo", 
                  "Cena: Ensalada griega"],
    "2801-3100": ["Desayuno: Tostadas con hummus", 
                  "Almuerzo: Pollo al curry con arroz", 
                  "Cena: Pavo al horno con papas"],
    "3101-3300": ["Desayuno: Huevos revueltos con espinacas", 
                  "Almuerzo: Hamburguesa vegana", 
                  "Cena: Pollo al limón con quinoa"],
    "3301-3600": ["Desayuno: Pan de plátano", 
                  "Almuerzo: Ensalada César con salmón", 
                  "Cena: Pizza casera vegetariana"],
    "3601-4000": ["Desayuno: Gofres de avena", 
...
def obtener_mensaje(calorias, imc, sexo):
    ...
    if calorias < 1500:
        ...
        return "Por encima de las 4000 calorías no se considera una dieta saludable. "
    else:
        if imc < 18.5:
            ...
            mensaje = "Tienes un IMC de obesidad. Considera reducir tu ingesta de calorías."
